...
* You can use the chapter \@ref(deployment) to run your own instance of a dockerized shiny app scraping and analysing far-right violence. 
* You can use the chapter \@ref(wrangle) for R scripts and snippets to create charts and maps out of your own incident data. If you have a data file with your own incidents, head there.
