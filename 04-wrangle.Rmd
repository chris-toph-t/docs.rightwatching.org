...
chronicle <- readr::read_csv(file.path("data", "dummy_chronicle_raw.csv"))

knitr::kable(
  head(chronicle, 10), caption = 'Your list of incidents may look like this'
)
```
...
knitr::kable(
  head(chronicle, 10), caption = 'Your list of incidents could look like this later'
)
```
